...
<%--
  ...
  2) 오류가 발생했을 때 해당 예외 객체를 출력하기 위해 exception 내장 객체를 작성.
  3) 오류가 발생했을 때 해당 예외 객체 타입을 가져오도록 표현문 태그에 exception 내장 객체의 toString() 메서드를 작성.
  4) 오류가 발생했을 때 해당 예외 객체 타입을 가져오도록 표현문 태그에
  exception 내장 객체의 getClass().getName() 메서드를 작성.
